#!/bin/sh
#install wsjt-x(2.7.0-rc3) Hamlib(4.5.4)
#N4XWE 01-10-2024
#Test Compiled on RaspiOS-bookworm dtd 2023-12-05 64-bit
...
wget -N https://sourceforge.net/projects/wsjt/files/wsjtx-2.7.0-rc3/wsjtx-2.7.0-rc3.tgz ||
  { echo 'Unable to download the WSJT-X source code file'; exit 1; }
  
#Extract the WSJT-X source code files
tar -zxvf wsjtx-2.7.0-rc3.tgz
