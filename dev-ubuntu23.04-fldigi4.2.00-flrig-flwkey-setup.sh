#!/bin/sh
#install fldigi(4.2.00) w/Hamlib(4.6-Git) flrig(2.0.03) flwkey(1.2.3) 
#N4XWE 09-05-2023
...
wget -N https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.2.00.tar.gz ||
...
wget -N https://sourceforge.net/projects/fldigi/files/flrig/flrig-2.0.03.tar.gz ||
