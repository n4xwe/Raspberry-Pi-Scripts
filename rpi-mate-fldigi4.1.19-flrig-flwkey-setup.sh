#!/bin/sh
#install fldigi(4.1.19) w/Hamlib(4.2) flrig(1.4.0) flwkey(1.2.3) 
#N4XWE 6-28-2021
...
wget -N https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.1.19.tar.gz ||
  { echo 'Unable to download the fldigi source code file'; exit 1; }

#Extract the fldigi source code files
tar -xvzf fldigi-4.1.19.tar.gz ||
