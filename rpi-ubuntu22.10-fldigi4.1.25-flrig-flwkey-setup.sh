#!/bin/sh
#install fldigi(4.1.25) w/Hamlib(4.6Git) flrig(1.4.7) flwkey(1.2.3) 
#N4XWE 2-28-2023
...
#Download the fldigi-4.1.25 source code from Sourceforge
wget -N https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.1.25.tar.gz ||
  { echo 'Unable to download the fldigi source code file'; exit 1; }

#Extract the fldigi source code files
tar -xvzf fldigi-4.1.25.tar.gz ||
