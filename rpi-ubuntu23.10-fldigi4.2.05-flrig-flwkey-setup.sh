#!/bin/sh
#install fldigi(4.2.04) w/Hamlib(4.5.5) flrig(2.0.05) flwkey(1.2.3) 
#N4XWE 09-09-2023
...
#Download the fldigi-4.2.04 source code from Sourceforge
wget https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.2.04.tar.gz ||
  { echo 'Unable to download the fldigi source code file'; exit 1; }

#Extract the fldigi source code files
tar -xvzf fldigi-4.2.04.tar.gz ||
