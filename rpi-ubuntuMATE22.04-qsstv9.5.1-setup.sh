#!/bin/sh
#install QSSTV(9.5.11) w/HamLib(4.5.2)
#N4XWE 12-24-2022
...
#Download the Hamlib 4.5.2 source code from Sourceforge
wget -N https://sourceforge.net/projects/hamlib/files/hamlib/4.5.2/hamlib-4.5.2.tar.gz ||
  { echo 'Unable to download the Hamlib source code file'; exit 1; }
  
#Extract the Hamlib source code files
tar -xvzf hamlib-4.5.2.tar.gz

#Change the directory containing the uncompressed HamLib source code to the current directory
cd ~/src/QSSTV/hamlib-4.5.2
