#!/bin/sh
#install fldigi(4.1.26) w/Hamlib(4.5.5) flrig(2.0.01) flwkey(1.2.3) 
#N4XWE 06-10-2023
...
wget https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.1.26.tar.gz ||
...
wget https://sourceforge.net/projects/fldigi/files/flrig/flrig-2.0.01.tar.gz ||
