...
wget https://sourceforge.net/projects/hamlib/files/hamlib/4.4/hamlib-4.4.tar.gz ||
...
wget https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.4.5.tar.gz ||
