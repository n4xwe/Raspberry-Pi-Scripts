#!/bin/sh
#install fldigi(4.2.00) w/Hamlib(4.5.5) flrig(2.0.03) flwkey(1.2.3) 
#N4XWE 09-11-2023
#Test Compiled on Ubuntu 22.04.3 LTS
...
#Download the fldigi-4.2.00 source code from Sourceforge
wget https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.2.00.tar.gz ||
  { echo 'Unable to download the fldigi source code file'; exit 1; }

#Extract the fldigi source code files
tar -xvzf fldigi-4.2.00.tar.gz ||
...
#Download the flrig 2.0.03 source code from Sourceforge
