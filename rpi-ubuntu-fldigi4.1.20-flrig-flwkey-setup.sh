#!/bin/sh
#install fldigi(4.1.20) w/Hamlib(4.3.1) flrig(1.4.2) flwkey(1.2.3) 
#N4XWE 9-28-2021
...
libfltk1.3-dev libflxmlrpc-dev libflxmlrpc1 libmbedcrypto3 libmbedtls-dev libmbedtls12 libudev-dev \
...
wget -N https://sourceforge.net/projects/hamlib/files/hamlib/4.3.1/hamlib-4.3.1.tar.gz ||
  { echo 'Unable to download the HamLib 4.3.1 code file'; exit 1; }
...
#Download the fldigi-4.1.19 source code from Sourceforge
